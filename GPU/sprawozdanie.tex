...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{images/1rstransactions.png}
    \caption{Koalescencyjne pobieranie danych do pamięci współdzielonej w wariancie 1-Res.}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{images/2rs.png}
    \caption{Pobieranie danych do pamięci współdzielonej w wariancie 2  -Res dla bloku $16 \times 16$.}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{images/4rs.png}
    \caption{Pobieranie danych do pamięci współdzielonej w wariancie 4-Res dla bloku $16 \times 16$.}
